...
namespace Carbon
{
    class Carbon
    {
         ...
         */
        public function setMaxIteration(int $maximum)
        {
         ...
         */
        public function diffInBusinessUnit(string $unit, $date = null, int $options = 0)
        {
         ...
         */
        public function diffAsBusinessInterval($date = null, int $options = 0)
        {
         ...
         * @return float
         */
        public function diffInBusinessSeconds($date = null, int $options = 0)
        {
         ...
         * @return float
         */
        public function diffInBusinessMinutes($date = null, int $options = 0)
        {
         ...
         * @return float
         */
        public function diffInBusinessHours($date = null, int $options = 0)
        {
         ...
         */
        public function getCurrentOpenTimePeriod($interval = null)
        {
